...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 text-base", className)} // ← larger font
      classNames={{
        months: "flex flex-col sm:flex-row space-y-6 sm:space-x-6 sm:space-y-0", // ↑ spacing
        month: "space-y-4",
        caption: "flex justify-center pt-1 relative items-center",
        caption_label: "text-md font-semibold", // ↑ label font
        ...
        table: "w-full border-collapse space-y-2", // ↑ spacing between weeks
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-10 h-10 font-medium text-sm", // ↑ header size
