...
-- Date: 2025-05-23T21:16:34.266Z

BEGIN;

-- Table: tours
INSERT INTO tours (id, name, description, imageUrl, duration, maxGroupSize, difficulty, price, badge, badgeColor, isActive) VALUES (1, 'Historic Belém Tour', 'Explore the historic Belém district including the iconic Tower, Monument to the Discoveries, and the famous Pastéis de Belém bakery.', 'https://images.unsplash.com/photo-1555881400-74d7acaacd8b', '3 hours', 12, 'Moderate', 4500, 'Most Popular', 'primary', TRUE);
