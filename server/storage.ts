...
export class MemStorage implements IStorage {
  ...
  async createTour(tour: InsertTour): Promise<Tour> {
    ...
    const newTour: Tour = {
      ...
      displayDurationInCard: tour.displayDurationInCard ?? true,
      displayGroupSizeInCard: tour.displayGroupSizeInCard ?? true,
      displayChildrenInCard: tour.displayChildrenInCard ?? true,
      displayConductedByInCard: tour.displayConductedByInCard ?? true,
      displayDifficultyInCard: tour.displayDifficultyInCard ?? true,
      childrenPolicy: tour.childrenPolicy ?? "allowed",
      conductedBy: tour.conductedBy ?? "walking",
