 ...
 * Includes complete schema creation and all data
 */
async function exportDatabase() {
  try {
    ...
    outputStream.write(`-- This SQL file contains all schema and data for the Lisbonlovesme tour booking application.\n`);
    outputStream.write(`-- It can be imported to a fresh PostgreSQL database to recreate the entire application database.\n\n`);
    outputStream.write(`BEGIN;\n\n`);
    
    // Write schema definitions for all tables
    outputStream.write(`-- ===================================\n`);
