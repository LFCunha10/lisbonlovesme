...
export const tours = pgTable("tours", {
  ...
  displayChildrenInCard: boolean("display_children_in_card").notNull().default(true),
  displayConductedByInCard: boolean("display_conducted_by_in_card").notNull().default(true),
  displayDifficultyInCard: boolean("display_difficulty_in_card").notNull().default(true),
  childrenPolicy: text("children_policy").notNull().default("allowed"),
  conductedBy: text("conducted_by").notNull().default("walking"),
